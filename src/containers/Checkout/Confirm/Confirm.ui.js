...
const ConfirmWarning = () => {
  ...
  return (
    <div className="ui--warning ui--warning-confirm">
      {iconUserData}
      <p>
        <span><b>IMPORTANTE: </b>Según Ley de Terminales Móviles Decreto 08-2013 para recibir tu teléfono si la entrega es a domicilio es necesario entregar una <b>fotocopia del DUI</b> con el que realizaste la compra y si la entrega es en únicamente debes presentar el DUI con el que efectuaste la compra.</span>
